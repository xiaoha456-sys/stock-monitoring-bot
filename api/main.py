...
from api.schemas import BriefOut, BriefSectionOut, HoldingOrderOut, HoldingOut, HoldingUpdate, OrderLegOut
...
app = FastAPI(title="Portfolio Brief API", version="0.3.0")
app.add_middleware(
    CORSMiddleware,
